    ...
    public partial class Provincia : Form // Formulario de Provincia
    {
        ...
        public void CarDat() // Cargar datos
        {
            try // Intentar
            {
                ...
                foreach (ERegion item in DRegion.Instancia.Listar()) // Por cada región
                {
            ...
            try // Intentar
            {
                ...
                foreach (EProvincia item in DProvincia.Instancia.Listar()) // Por cada región
                {
            ...
            try // Intentar
            {
                ...
                foreach (EProvincia item in DProvincia.Instancia.Listar()) // Por cada provincia
                {
        ...
        private void Eliminar_Click(object sender, EventArgs e) // Al clickear eliminar
        {
            ...
            if (res == DialogResult.Yes)
            {
                ...
                {
                    bool resultado = DProvincia.Instancia.Eliminar(Id); // Eliminar provincia
                    if (resultado)
                    {
        ...
        private void Ingresar_Click(object sender, EventArgs e) // Al clickear ingresar
        {
            ...
            foreach (ERegion item in DRegion.Instancia.Listar()) // Por cada region
            {
            ...
            if (res == DialogResult.Yes)
            {
                bool resultado = DProvincia.Instancia.Ingresar(Ent); // Ingresar provincia
        ...
        private void Modificar_Click(object sender, EventArgs e) // Al clickear modificar
        {
            ...
            if (res == DialogResult.Yes)
            {
                bool resultado = DProvincia.Instancia.Actualizar(Ent); // Actualizar provincia
                if (resultado)
                {
        ...
        private void IngresarRegion_Click(object sender, EventArgs e) // Al clickear ingresar región
        {
            ...
            if (res == DialogResult.Yes)
            {
                bool resultado = DRegion.Instancia.Ingresar(EntReg); // Ingresar región
        ...
        private void IngresarComuna_Click(object sender, EventArgs e) // Al clickear ingresar comuna
        {
            ...
            if (res == DialogResult.Yes)
            {
                bool resultado = DComuna.Instancia.Ingresar(EntCom); // Ingresar comuna
